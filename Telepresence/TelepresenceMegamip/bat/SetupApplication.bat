...
:: Android packaging
set AND_CERT_NAME="TelepresenceMegamip"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\TelepresenceMegamip.p12
...
set IOS_PROVISION=cert\TelepresenceMegamip.mobileprovision
...
set APP_ID=air.TelepresenceMegamip

:: Output packages
set DIST_PATH=dist
set DIST_NAME=TelepresenceMegamip
