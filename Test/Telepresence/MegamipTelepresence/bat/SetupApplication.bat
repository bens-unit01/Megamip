...
:: Android packaging
set AND_CERT_NAME="MegamipTelepresence"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\MegamipTelepresence.p12
...
set IOS_PROVISION=cert\MegamipTelepresence.mobileprovision
...
set APP_ID=air.MegamipTelepresence

:: Output packages
set DIST_PATH=dist
set DIST_NAME=MegamipTelepresence
