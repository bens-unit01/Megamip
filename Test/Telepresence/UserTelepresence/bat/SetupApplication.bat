...
:: Android packaging
set AND_CERT_NAME="UserTelepresence"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\UserTelepresence.p12
...
set IOS_PROVISION=cert\UserTelepresence.mobileprovision
...
set APP_ID=air.UserTelepresence

:: Output packages
set DIST_PATH=dist
set DIST_NAME=UserTelepresence
