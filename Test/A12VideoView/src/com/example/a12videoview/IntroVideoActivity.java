			...
			for(int i=0; i<lArgs.length; i++){
				...
				if(lArgValStrArr != null){
					if(lArgValStrArr.length >= 2){
						...
						Log.d("TAG3", " IntroVideoActivity for loop - lArgValStrArr: "+lArgValStrArr[1]);
					}
				}
			}
			
			String lTokenStr = URLDecoder.decode(lArgMap.get("token"));
        //      String lTokenStr = "AIzaSyBUpZz3SZw6LGRP7Dfwd3K_Zq6VBXccpHI";
		   lUriStr = "http://www.youtube.com/get_video?video_id="+pYouTubeVideoId+"&t="+URLEncoder.encode(lTokenStr)+"&fmt="+pYouTubeFmtQuality;
			
		//	lUriStr ="https://www.youtube.com/v/bBH0ele7qdw?version=3&f=videos&app=youtube_gdata&t=AIzaSyDnzEMrqVRm5TZBCuB28--1bz-3-IZbn3E";
			
	//		lUriStr ="https://www.youtube.com/v/bBH0ele7qdw";
		   
		   Log.d("TAG3", " IntroVideoActivity lUriStr: "+lUriStr);
			return lUriStr;
		}
		...
		private void showErrorAlert() {
			...
			lBuilder.setPositiveButton(getResources().getString(R.string.hello_world), new DialogInterface.OnClickListener(){
