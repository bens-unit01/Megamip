...
:: Android packaging
set AND_CERT_NAME="TelepresenceUser"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\TelepresenceUser.p12
...
set IOS_PROVISION=cert\TelepresenceUser.mobileprovision
...
set APP_ID=air.TelepresenceUser

:: Output packages
set DIST_PATH=dist
set DIST_NAME=TelepresenceUser
