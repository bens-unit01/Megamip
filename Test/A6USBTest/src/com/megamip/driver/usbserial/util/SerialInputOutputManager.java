...
package com.megamip.driver.usbserial.util;
...
public class SerialInputOutputManager implements Runnable {
    ...
    private static final String TAG2 = "A3";
    ...
    private void step() throws IOException {
        // Handle incoming data.
    	 int len = 0;
    	Log.d(TAG2, "SerialInputOutputManager step() *1 mDriver = "+mDriver);
    
        len = mDriver.read(mReadBuffer.array(), READ_WAIT_MILLIS);
    
        
    	Log.d(TAG2, "SerialInputOutputManager step() *3 len="+len);
        if (len > 0) {
