...
:: Android packaging
set AND_CERT_NAME="MipVideoPlayer"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\MipVideoPlayer.p12
...
set IOS_PROVISION=cert\MipVideoPlayer.mobileprovision
...
set APP_ID=air.MipVideoPlayer

:: Output packages
set DIST_PATH=dist
set DIST_NAME=MipVideoPlayer
